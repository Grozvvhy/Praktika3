                    ...
                    using (var cmd = new SqlCommand(query, connection))
                    {
                        ...
                        using (var reader = cmd.ExecuteReader())
                        {
                            if (reader.Read())
                            {
                                ...
                                // Пароль не проверяем – для теста подходит любой пароль
                                // Если нужно вернуть проверку, раскомментируйте строки ниже и убедитесь, что установлен BCrypt.Net-Next
                                /*
